...
public class PhotoTools {
     ...
     * @return
     */
    public static List<PhotoFolderInfo> getAllPhotoFolder(Context context, List<String> selectPhotoMap) {
        ...
        allPhotoFolderInfo.setPhotoList(new ArrayList<String>());
                ...
                while (cursor.moveToNext()) {
                    ...
                    if ( (filterList == null || !filterList.contains(path)) && file.exists() && file.length() > 0 ) {
                        ...
                        if (allPhotoFolderInfo.getCoverPhoto() == null) {
                            allPhotoFolderInfo.setCoverPhoto(path);
                        }
                        //添加到所有图片
                        allPhotoFolderInfo.getPhotoList().add(path);
