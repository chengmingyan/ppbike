 ...
 */
public class PhotoEditListAdapter extends ViewHolderAdapter<PhotoEditListAdapter.ViewHolder, String> {

    private PhotoEditActivity mActivity;
    private int mRowWidth;

    public PhotoEditListAdapter(PhotoEditActivity activity, List<String> list, int screenWidth) {
        super(activity, list);
        mActivity = activity;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mIvDelete.setImageResource(R.drawable.ic_delete_photo);
        Drawable defaultDrawable = mActivity.getResources().getDrawable(R.drawable.ic_gf_default_photo);
        GalleryFinal.getCoreConfig().getImageLoader().displayImage(mActivity, photoInfo, holder.mIvPhoto, defaultDrawable, 100, 100);
