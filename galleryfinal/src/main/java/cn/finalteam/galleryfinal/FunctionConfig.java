...
public class FunctionConfig implements Cloneable{
    ...
    public static class Builder {
        ...
        public Builder setSelected(Collection<String> selectedList) {
            if ( selectedList != null ) {
                ArrayList<String> list = new ArrayList<>();
                for(String info:selectedList) {
                    if (info != null) {
                        list.add(info );
                    }
                }
        ...
        public Builder setFilter(Collection<String> filterList) {
            if ( filterList != null ) {
                ArrayList<String> list = new ArrayList<>();
                for(String info:filterList) {
                    if (info != null) {
                        list.add(info );
                    }
                }
