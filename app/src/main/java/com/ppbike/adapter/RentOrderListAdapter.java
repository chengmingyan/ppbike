 ...
 */
public class RentOrderListAdapter extends BaseAdapter{
    private ArrayList<RentBikeOrderList> datas;
    private UpdateOrderListener listener;
    public RentOrderListAdapter (UpdateOrderListener listener){
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ItemView view = null;
        if (convertView == null){
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_rent_orderlist,null);
            view = new ItemView();
    ...
    class ItemView{
        public TextView tv_type,tv_bikeTitle,tv_bikeInfo,tv_oPrice,tv_pPrice;
