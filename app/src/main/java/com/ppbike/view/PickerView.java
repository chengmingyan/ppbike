...
public class PickerView extends View {
     ...
     */
    public float MARGIN_ALPHA = 69 / 12f;

    public void setMARGIN_ALPHA(float MARGIN_ALPHA) {
    ...
    private final float mMinTextAlpha = 60;

    private final int mColorText = 0xffffff;
    ...
    private void performSelect() {
        if (mSelectListener != null)
            mCurrentSelectedItem = mDataList.get(mCurrentSelected);
    ...
    private void init() {
        ...
        mLinePaint.setColor(Color.rgb(240, 240, 240));
    }
    ...
    private void drawData(Canvas canvas) {
        ...
        float y1 = mViewHeight / 320f * 90;
        float y2 = mViewHeight / 320f * 230;
        FontMetricsInt fmi = mPaint.getFontMetricsInt();
        float baseline = (float) (y - (fmi.bottom / 2.0 + fmi.top / 2.0));

        canvas.drawLine(0, y1, mViewWidth, y1, mLinePaint);
        canvas.drawLine(0, y2, mViewWidth, y2, mLinePaint);
    ...
    public interface onSelectListener {
        void onSelect(PickerView v, String text);
    }
}
