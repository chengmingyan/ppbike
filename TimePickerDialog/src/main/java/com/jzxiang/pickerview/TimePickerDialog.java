...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    */
    void sureClicked() {
        ...
        mCurrentMillSeconds = mTimeWheel.getTime();
    ...
    public static class Builder {
        ...
        public Builder setCurrentTimeMillseconds(long timeMillseconds){
            mPickerConfig.currentTimeMillseconds = timeMillseconds;
            return this;
        }

        public Builder setDayNumber(int dayNumber){
            mPickerConfig.dayNumber = dayNumber;
            return  this;
        }
